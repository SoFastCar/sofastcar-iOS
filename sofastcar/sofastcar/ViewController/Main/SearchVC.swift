...
class SearchVC: UIViewController {
    ...
    lazy var noDataView = UIView(frame: CGRect(x: 0, y: 0, width: searchView.searchResultTableView.bounds.size.width, height: searchView.searchResultTableView.bounds.size.height))
