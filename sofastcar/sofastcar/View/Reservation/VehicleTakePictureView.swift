...
class VehicleTakePictureView: UICollectionView {
...
//    tableView.register(VehicleTakePicturTableHeaderView.self, forHeaderFooterViewReuseIdentifier: VehicleTakePicturTableHeaderView.identifier)
